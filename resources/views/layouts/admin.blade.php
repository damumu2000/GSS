...
@php
    ...
    $icons = [
        ...
        'question' => '<svg viewBox="0 0 24 24"><path d="M9.09 9a3 3 0 1 1 5.82 1c0 2-3 3-3 3"/><path d="M12 17h.01"/><circle cx="12" cy="12" r="9"/></svg>',
        ...
        <header class="app-header">
            ...
            <div class="header-user">
                ...
                @if ($activeAdminArea === 'site' && $currentSite)
                    <a class="frontend-visit-link" href="{{ \App\Support\SiteFrontendUrl::homeUrl($currentSite) }}" target="_blank" rel="noopener" data-tooltip="前端">
                        <span class="button-icon">{!! $icons['external-link'] !!}</span>
                        <span>前端</span>
                    </a>
                    <a class="frontend-visit-link" href="https://www.guanshanshan.cn/cat/help" target="_blank" rel="noopener" data-tooltip="帮助">
                        <span class="button-icon">{!! $icons['question'] !!}</span>
                        <span>帮助</span>
                    </a>
                @endif
