                ...
                @if ($recentContents->isNotEmpty())
                    <div class="recent-feed">
                        @foreach ($recentContents as $content)
                            ...
                            @endphp
                            <article class="recent-feed-item" onclick="window.open('{{ $recentContentLink }}', '_blank', 'noopener')" style="cursor:pointer;">
                                <div class="recent-feed-main">
                                    <a class="recent-feed-title" href="{{ $recentContentLink }}" target="_blank" rel="noopener" onclick="event.stopPropagation()" data-tooltip="{{ $recentContentTitle }}">
