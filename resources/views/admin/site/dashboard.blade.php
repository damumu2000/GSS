                ...
                @if ($recentContents->isNotEmpty())
                    <div class="recent-feed">
                        @foreach ($recentContents as $content)
                            ...
                            @endphp
                            <article class="recent-feed-item @if ($canManageContent) is-clickable @endif" @if ($canManageContent) data-recent-feed-url="{{ $content->type === 'page' ? route('admin.pages.edit', $content->id) : route('admin.articles.edit', $content->id) }}" @endif>
                                <div class="recent-feed-main" data-tooltip="{{ $recentContentTitle }}">
                                    @if ($canManageContent)
                                        <a class="recent-feed-title" href="{{ $content->type === 'page' ? route('admin.pages.edit', $content->id) : route('admin.articles.edit', $content->id) }}">
                                            {{ $recentContentTitle }}
                                        </a>
                                    @else
                                        <div class="recent-feed-title">{{ $recentContentTitle }}</div>
                                    @endif
                                </div>
