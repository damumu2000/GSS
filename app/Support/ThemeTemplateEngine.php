...
class ThemeTemplateEngine
{
    ...
    protected const DIRECTIVE_ARGUMENTS = [
        ...
        'childNav' => ['id', 'channel_id', 'slug', 'limit', 'fields'],
        ...
        'related' => ['value', 'limit'],
        'first' => ['value'],
        'promo' => ['code', 'limit', 'fields', 'random'],
        'promos' => ['code', 'limit', 'fields', 'random'],
        'promoFloating' => ['code'],
        'themeAsset' => ['path'],
        'themeStyle' => ['path'],
        'themeScript' => ['path'],
    ...
    protected function invokeFunctionLikeCommand(string $name, array $options, array $context, bool $validateOnly = false): mixed
    {
        ...
        return match ($name) {
            ...
            'localNav' => $this->tags->localNav($options),
            'childNav' => $this->tags->childNav($options),
            ...
            'promoFloating' => $this->tags->promoFloating((string) ($options['code'] ?? '')),
